...
ent-ClothingOuterApronBar = apron
    .desc = A darker apron designed for bartenders.    .suffix = Bartender
ent-ClothingOuterApronBotanist = apron
    .desc = A thick blue-apron, perfect for insulating your soft flesh from spills, soil and thorns.    .suffix = Botanical
ent-ClothingOuterApronChef = apron
    .desc = An apron-jacket used by a high class chef.    .suffix = Chef
