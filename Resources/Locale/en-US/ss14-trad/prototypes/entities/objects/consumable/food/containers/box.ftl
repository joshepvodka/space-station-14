...
ent-HappyHonk = happy honk meal
    .desc = The toy is more edible than the food.    .suffix = Toy Safe
ent-HappyHonkMime = { ent-HappyHonk }
    .desc = A limited mime edition of the happy honk meal.    .suffix = Toy Safe
ent-HappyHonkNukie = robust nukie meal
    .desc = A sus meal with a potentially explosive surprise.    .suffix = Toy Unsafe
