...
ent-PlushieGhostRevenant = revenant soft toy
    .desc = So soft it almost makes you want to take a nap...    .suffix = DO NOT MAP
...
ent-RevolverCapGunFake = cap gun
    .desc = Looks almost like the real thing! Ages 8 and up.    .suffix = Fake
...
ent-PlasticBanana = banana
    .desc = A plastic banana.    .suffix = Plastic
