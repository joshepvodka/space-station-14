...
ent-EnergyDagger = pen
    .desc = A dark ink pen.    .suffix = E-Dagger
ent-EnergyDaggerBox = e-dagger box
    .desc = A small box containing an e-dagger. Packaging disintegrates when opened, leaving no evidence behind.    .suffix = E-Dagger
