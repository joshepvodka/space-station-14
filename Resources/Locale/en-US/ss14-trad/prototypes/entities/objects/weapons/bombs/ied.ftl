...
ent-ImprovisedExplosiveEmpty = improvised explosive device
    .desc = A weak, improvised incendiary device. This one has no fuel.    .suffix = empty
ent-ImprovisedExplosiveFuel = { ent-ImprovisedExplosiveEmpty }
    .desc = A weak, improvised incendiary device. This one is missing wires.    .suffix = fuel
