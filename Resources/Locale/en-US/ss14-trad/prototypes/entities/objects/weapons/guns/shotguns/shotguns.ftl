...
ent-WeaponShotgunDoubleBarreledRubber = double-barreled shotgun
    .desc = An immortal classic. Uses .50 shotgun shells.    .suffix = Non-Lethal
...
ent-WeaponShotgunSawnEmpty = sawn-off shogun
    .desc = Groovy! Uses .50 shotgun shells.    .suffix = Empty
...
ent-WeaponShotgunBlunderbuss = blunderbuss
    .desc = Deadly at close range.    .suffix = Pirate
