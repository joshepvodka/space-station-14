...
ent-WeaponSubMachineGunVector = Vector
    .desc = An excellent fully automatic Heavy SMG. Uses .45 magnum ammo.    .suffix = Deprecated use Drozd
...
ent-WeaponSubMachineGunVectorRubber = Vector
    .desc = An excellent fully automatic Heavy SMG. Uses .45 magnum ammo.    .suffix = Non-Lethal
