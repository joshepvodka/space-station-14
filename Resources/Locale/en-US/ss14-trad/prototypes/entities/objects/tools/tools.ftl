...
ent-RCDRecharging = experimental rcd
    .desc = A bluespace-enhanced RCD that regenerates charges passively.    .suffix = AutoRecharge
ent-RCDExperimental = experimental rcd
    .desc = A bluespace-enhanced RCD that regenerates charges passively.    .suffix = Admeme
