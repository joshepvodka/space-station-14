...
ent-MobAngryBee = bee
    .desc = How nice a bee. Oh no, it looks angry and wants my pizza.    .suffix = Angry
...
ent-MobGlockroach = glockroach
    .desc = This station is just crawling with bu- OH GOD THAT COCKROACH HAS A GUN!!!    .suffix = Admeme
...
ent-MobBaseSyndicateMonkey = monkey
    .desc = New church of neo-darwinists actually believe that EVERY animal evolved from a monkey. Tastes like pork, and killing them is both fun and relaxing.    .suffix = syndicate base
