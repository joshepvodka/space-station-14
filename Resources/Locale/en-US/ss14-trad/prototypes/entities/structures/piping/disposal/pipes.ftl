...
ent-DisposalRouterFlipped = { ent-DisposalRouter }
    .desc = A three-way router. Entities with matching tags get routed to the side.    .suffix = flipped
...
ent-DisposalJunctionFlipped = { ent-DisposalJunction }
    .desc = A three-way junction. The arrow indicates where items exit.    .suffix = flipped
