...
head-rev-role-greeting =     You are a Head Revolutionary.
    ...
    Viva la revolución!
head-rev-briefing =     Use flashes to convert people to your cause.
...
rev-role-greeting =     You are a Revolutionary.
...
rev-deconverted-text =     As the last headrev has died, the revolution is over.
