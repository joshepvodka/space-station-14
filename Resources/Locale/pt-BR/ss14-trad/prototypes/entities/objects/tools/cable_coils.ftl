...
ent-CableHVStack = HV cable coil
    .desc = HV cables for connecting engines to heavy duty machinery, SMESes, and substations.    .suffix = Full
...
ent-CableMVStack = MV cable coil
    .desc = MV cables for connecting substations to APCs, and also powering a select few things like emitters.    .suffix = Full
...
ent-CableApcStack = LV cable coil
    .desc = Low-Voltage stack of wires for connecting APCs to machines and other purposes.    .suffix = Full
