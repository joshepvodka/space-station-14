...
ent-ClosetJanitorBomb = janitorial bomb suit closet
    .desc = It's a storage unit for janitorial explosion-protective suits.    .suffix = DO NOT MAP
...
ent-ClosetBluespace = suspicious closet
    .desc = It's a storage unit... right?    .suffix = Bluespace
ent-ClosetBluespaceUnstable = suspicious closet
    .desc = It's a storage unit... right?    .suffix = Bluespace unstable
