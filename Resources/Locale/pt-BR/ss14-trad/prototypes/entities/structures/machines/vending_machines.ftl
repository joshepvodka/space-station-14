...
ent-VendingMachineSeedsUnlocked = MegaSeed Servitor
    .desc = For when you need seeds fast. Hands down the best seed selection on the station!    .suffix = Unlocked
...
ent-VendingMachineTankDispenserEVA = gas tank dispenser
    .desc = A vendor for dispensing gas tanks.    .suffix = EVA [O2, N2]
ent-VendingMachineTankDispenserEngineering = gas tank dispenser
    .desc = A vendor for dispensing gas tanks. This one has an engineering livery.    .suffix = ENG [O2, Plasma]
