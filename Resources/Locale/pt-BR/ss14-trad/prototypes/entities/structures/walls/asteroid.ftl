...
ent-AsteroidRockBananium = { ent-AsteroidRock }
    .desc = An ore vein rich with bananium.    .suffix = Bananium
ent-AsteroidRockArtifactFragment = { ent-AsteroidRock }
    .desc = A rock wall. What's that sticking out of it?    .suffix = Artifact Fragment
ent-AsteroidRockMining = asteroid rock
    .desc = An asteroid.    .suffix = higher ore yield
