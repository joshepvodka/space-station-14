...
ent-ParticleAcceleratorEmitterPortUnfinished = PA port containment emitter
    .desc = This launchs the Alpha particles, might not want to stand near this end. It looks unfinished.    .suffix = Unfinished, Port
ent-ParticleAcceleratorEmitterForeUnfinished = PA fore containment emitter
    .desc = This launchs the Alpha particles, might not want to stand near this end. It looks unfinished.    .suffix = Unfinished, Fore
ent-ParticleAcceleratorEmitterStarboardUnfinished = PA starboard containment emitter
    .desc = This launchs the Alpha particles, might not want to stand near this end. It looks unfinished.    .suffix = Unfinished, Starboard
