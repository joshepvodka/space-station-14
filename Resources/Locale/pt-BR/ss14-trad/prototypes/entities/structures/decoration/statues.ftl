ent-StatueVenusRed = statue of a pure maiden
    .desc = An ancient marble statue. The subject is depicted with a floor-length braid and is wielding a red toolbox.    .suffix = Red
ent-StatueVenusBlue = statue of a pure maiden
    .desc = An ancient marble statue. The subject is depicted with a floor-length braid and is wielding a blue toolbox.    .suffix = Blue
