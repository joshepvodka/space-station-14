ent-ClothingHeadHatHoodBioGeneral = bio hood
    .desc = A hood that protects the head and face from biological contaminants.    .suffix = Generic
ent-ClothingHeadHatHoodBioCmo = bio hood
    .desc = An advanced hood for chief medical officers that protects the head and face from biological contaminants.    .suffix = CMO
ent-ClothingHeadHatHoodBioJanitor = bio hood
    .desc = A hood that protects the head and face from biological contaminants.    .suffix = Janitor
ent-ClothingHeadHatHoodBioScientist = bio hood
    .desc = A hood that protects the head and face from biological contaminants.    .suffix = Science
ent-ClothingHeadHatHoodBioSecurity = bio hood
    .desc = A hood that protects the head and face from biological contaminants.    .suffix = Security
ent-ClothingHeadHatHoodBioVirology = bio hood
    .desc = A hood that protects the head and face from biological contaminants.    .suffix = Virology
