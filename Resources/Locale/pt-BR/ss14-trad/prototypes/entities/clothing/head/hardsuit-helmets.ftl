...
ent-ClothingHeadHelmetHardsuitPirateEVA = deep space EVA helmet
    .desc = A deep space EVA helmet, very heavy but provides good protection.    .suffix = Pirate
ent-ClothingHeadHelmetHardsuitPirateCap = pirate captain's hardsuit helmet
    .desc = A special hardsuit helmet, made for the captain of a pirate ship.    .suffix = Pirate
