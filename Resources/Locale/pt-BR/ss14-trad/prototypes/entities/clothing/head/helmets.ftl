...
ent-ClothingHeadHelmetSwatSyndicate = SWAT helmet
    .desc = An extremely robust helmet, commonly used by paramilitary forces. It is adorned in a nefarious red and black stripe pattern.    .suffix = Syndicate
...
ent-ClothingHeadHelmetJanitorBombSuit = janitorial bombsuit helmet
    .desc = A heavy helmet designed to withstand explosions formed from reactions between chemicals.    .suffix = DO NOT MAP
